...
**Not Applicable - there are some NAs for admission in 2021 that need to be removed before the mean and median can be calculated **
...
**there are some locations that had very high admissions in 2021 that lead to the mean being skewed to a higher value then the median**
